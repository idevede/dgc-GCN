...
#from tensorflow import rnn_cell #add when tf = 1.3
from tensorflow.python.ops import rnn_cell
#from . import attention_encoder
from tools.utils import * #import *
from tools.Generate_stock_data import *#Generate_stock_data as GD
import pandas as pd
...
#        loss_test=[]
        ...
        # Launch the graph
        with tf.Session(config=tf.ConfigProto()) as sess:#gpu_options=gpu_options
            ...
            Data = Input_data(batch_size, n_steps_encoder, n_steps_decoder, n_hidden_encoder, i, filename, n_classes, horizon)
